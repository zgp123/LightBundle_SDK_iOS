...
- (id)initWithTitle:(NSString *)inTitle message:(NSString *)inMessage cancelButtonItem:(LBRIButtonItem *)inCancelButtonItem otherButtonItems:(LBRIButtonItem *)inOtherButtonItems, ...
{
