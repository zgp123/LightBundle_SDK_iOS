...
@class LBZXBitArray, LBZXRSSExpandedGeneralAppIdDecoder;

@interface LBZXAbstractExpandedDecoder : NSObject

@property (nonatomic, strong, readonly) LBZXRSSExpandedGeneralAppIdDecoder *generalDecoder;
