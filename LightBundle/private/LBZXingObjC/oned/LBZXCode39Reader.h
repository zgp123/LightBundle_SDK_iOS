...
extern unichar LBZX_CODE39_ALPHABET[];
extern NSString *LBZX_CODE39_ALPHABET_STRING;
extern const int LBZX_CODE39_CHARACTER_ENCODINGS[];
 ...
 */
@interface LBZXCode39Reader : LBZXOneDReader
