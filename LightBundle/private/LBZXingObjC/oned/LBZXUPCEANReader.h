...
typedef enum {
	LBZX_UPC_EAN_PATTERNS_L_PATTERNS = 0,
	LBZX_UPC_EAN_PATTERNS_L_AND_G_PATTERNS
} LBZX_UPC_EAN_PATTERNS;

extern const int LBZX_UPC_EAN_START_END_PATTERN_LEN;
extern const int LBZX_UPC_EAN_START_END_PATTERN[];
extern const int LBZX_UPC_EAN_MIDDLE_PATTERN_LEN;
extern const int LBZX_UPC_EAN_MIDDLE_PATTERN[];
extern const int LBZX_UPC_EAN_L_PATTERNS_LEN;
extern const int LBZX_UPC_EAN_L_PATTERNS_SUB_LEN;
extern const int LBZX_UPC_EAN_L_PATTERNS[][4];
extern const int LBZX_UPC_EAN_L_AND_G_PATTERNS_LEN;
extern const int LBZX_UPC_EAN_L_AND_G_PATTERNS_SUB_LEN;
extern const int LBZX_UPC_EAN_L_AND_G_PATTERNS[][4];

@class LBZXDecodeHints, LBZXEANManufacturerOrgSupport, LBZXIntArray, LBZXResult, LBZXUPCEANExtensionSupport;

/**
 * Encapsulates functionality and implementation that is common to UPC and EAN families
 * of one-dimensional barcodes.
 */
@interface LBZXUPCEANReader : LBZXOneDReader
