...
@class LBZXBinarizer, LBZXBitArray, LBZXBitMatrix;

/**
 * This class is the core bitmap class used by LBZXing to represent 1 bit data. Reader objects
 * accept a BinaryBitmap and attempt to decode it.
 */
@interface LBZXBinaryBitmap : NSObject
 ...
 */
- (LBZXBinaryBitmap *)crop:(int)left top:(int)top width:(int)width height:(int)height;
