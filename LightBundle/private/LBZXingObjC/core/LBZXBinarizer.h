 ...
 */
@interface LBZXBinarizer : NSObject

@property (nonatomic, strong, readonly) LBZXLuminanceSource *luminanceSource;
 ...
 *            If used, the Binarizer will call LBZXBitArray clear. Always use the returned object.
