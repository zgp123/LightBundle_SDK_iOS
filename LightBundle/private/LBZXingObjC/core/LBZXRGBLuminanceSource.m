...
@interface LBZXRGBLuminanceSource ()

@property (nonatomic, strong, readonly) LBZXByteArray *luminances;
...
@implementation LBZXRGBLuminanceSource
...
- (id)initWithWidth:(int)width height:(int)height pixels:(int *)pixels pixelsLen:(int)pixelsLen {
  if (self = [super initWithWidth:width height:height]) {
    ...
    _luminances = [[LBZXByteArray alloc] initWithLength:width * height];
...
- (id)initWithPixels:(LBZXByteArray *)pixels dataWidth:(int)dataWidth dataHeight:(int)dataHeight
