...
@implementation LBZXDataMatrixC40Encoder

- (int)encodingMode {
  return [LBZXDataMatrixHighLevelEncoder c40Encodation];
}
...
- (int)backtrackOneCharacter:(LBZXDataMatrixEncoderContext *)context buffer:(NSMutableString *)buffer
...
- (void)writeNextTriplet:(LBZXDataMatrixEncoderContext *)context buffer:(NSMutableString *)buffer {
...
- (void)handleEOD:(LBZXDataMatrixEncoderContext *)context buffer:(NSMutableString *)buffer {
  ...
  if (rest == 2) {
    ...
    if ([context hasMoreCharacters]) {
      [context writeCodeword:[LBZXDataMatrixHighLevelEncoder c40Unlatch]];
    }
