 ...
 */
@interface LBZXDataMatrixSymbolInfo : NSObject
...
+ (LBZXDataMatrixSymbolInfo *)lookup:(int)dataCodewords shape:(LBZXDataMatrixSymbolShapeHint)shape minSize:(LBZXDimension *)minSize maxSize:(LBZXDimension *)maxSize fail:(BOOL)fail;
