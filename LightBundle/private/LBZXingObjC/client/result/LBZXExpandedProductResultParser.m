...
@implementation LBZXExpandedProductResultParser
...
- (LBZXParsedResult *)parse:(LBZXResult *)result {
  ...
  return [LBZXExpandedProductParsedResult expandedProductParsedResultWithRawText:rawText
                                                                     productID:productID
                                                                          sscc:sscc
                                                                     lotNumber:lotNumber
