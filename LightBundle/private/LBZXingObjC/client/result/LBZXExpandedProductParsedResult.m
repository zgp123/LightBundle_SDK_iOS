...
NSString * const LBZX_KILOGRAM = @"KG";
NSString * const LBZX_POUND = @"LB";

@implementation LBZXExpandedProductParsedResult
...
- (BOOL)isEqual:(id)o {
  ...
  LBZXExpandedProductParsedResult *other = (LBZXExpandedProductParsedResult *)o;
