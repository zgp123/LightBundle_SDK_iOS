...
@class LBZXParsedResult, LBZXResult;
 ...
 */
@interface LBZXResultParser : NSObject

/**
 * Attempts to parse the raw LBZXResult's contents as a particular type
 * of information (email, URL, etc.) and return a LBZXParsedResult encapsulating
