...
@implementation LBZXVEventResultParser
...
- (LBZXParsedResult *)parse:(LBZXResult *)result {
  ...
  @try {
    return [LBZXCalendarParsedResult calendarParsedResultWithSummary:summary
                                                       startString:start
                                                         endString:end
...
- (NSString *)matchSingleVCardPrefixedField:(NSString *)prefix rawText:(NSString *)rawText trim:(BOOL)trim {
  NSArray *values = [LBZXVCardResultParser matchSingleVCardPrefixedField:prefix rawText:rawText trim:trim parseFieldDivider:NO];
...
- (NSMutableArray *)matchVCardPrefixedField:(NSString *)prefix rawText:(NSString *)rawText trim:(BOOL)trim {
  NSMutableArray *values = [LBZXVCardResultParser matchVCardPrefixedField:prefix rawText:rawText trim:trim parseFieldDivider:NO];
