...
@implementation LBZXEmailAddressParsedResult
...
- (NSString *)displayResult {
  ...
  [LBZXParsedResult maybeAppend:self.emailAddress result:result];
  [LBZXParsedResult maybeAppend:self.subject result:result];
  [LBZXParsedResult maybeAppend:self.body result:result];
  return result;
}
