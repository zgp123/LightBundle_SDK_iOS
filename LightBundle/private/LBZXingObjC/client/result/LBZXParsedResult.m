...
@implementation LBZXParsedResult

- (id)initWithType:(LBZXParsedResultType)type {
  if (self = [super init]) {
    _type = type;
  }
...
+ (id)parsedResultWithType:(LBZXParsedResultType)type {
    return  [[LBZXParsedResult alloc] initWithType:type];
//  return [[[LBZXParsedResult class] alloc] initWithType:type];
}
