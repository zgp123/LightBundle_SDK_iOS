...
@interface LBZXCGImageLuminanceSource ()
...
@implementation LBZXCGImageLuminanceSource
...
- (id)initWithLBZXImage:(LBZXImage *)image
                 left:(size_t)left
                  top:(size_t)top
                width:(size_t)width
...
- (id)initWithBuffer:(CVPixelBufferRef)buffer
               ...
               width:(size_t)width
              height:(size_t)height {
  CGImageRef image = [LBZXCGImageLuminanceSource createImageFromBuffer:buffer left:left top:top width:width height:height];
...
- (id)initWithBuffer:(CVPixelBufferRef)buffer {
  CGImageRef image = [LBZXCGImageLuminanceSource createImageFromBuffer:buffer];
...
- (LBZXByteArray *)rowAtY:(int)y row:(LBZXByteArray *)row {
  ...
  if (!row || row.length < self.width) {
    row = [[LBZXByteArray alloc] initWithLength:self.width];
  }
...
- (LBZXLuminanceSource *)rotateCounterClockwise {
  ...
  LBZXCGImageLuminanceSource *result = [[LBZXCGImageLuminanceSource alloc] initWithCGImage:rotatedImage
                                                                                  left:self.top
