...
@protocol LBZXCaptureDelegate, LBZXReader;
@class LBZXDecodeHints;

@interface LBZXCapture : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate, CAAction>

@property (nonatomic, assign) int camera;
@property (nonatomic, strong) AVCaptureDevice *captureDevice;
@property (nonatomic, copy) NSString *captureToFilename;
@property (nonatomic, weak) id<LBZXCaptureDelegate> delegate;
...
@property (nonatomic, strong) id<LBZXReader> reader;
