...
@interface LBZXAztecBinaryShiftToken ()
...
@implementation LBZXAztecBinaryShiftToken

- (id)initWithPrevious:(LBZXAztecToken *)previous binaryShiftStart:(int)binaryShiftStart binaryShiftByteCount:(int)binaryShiftByteCount {
