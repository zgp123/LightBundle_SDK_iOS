...
@class LBZXBitMatrix, LBZXPerspectiveTransform;
 ...
 */
@interface LBZXGridSampler : NSObject
 ...
 */
+ (void)setGridSampler:(LBZXGridSampler *)newGridSampler;

/**
 * @return the current implementation of GridSampler
 */
+ (LBZXGridSampler *)instance;

/**
 * Samples an image for a rectangular matrix of bits of the given dimension.
 * @param image image to sample
 * @param dimensionX width of LBZXBitMatrix to sample from image
 * @param dimensionY height of LBZXBitMatrix to sample from image
 * @return LBZXBitMatrix representing a grid of points sampled from the image within a region
...
- (LBZXBitMatrix *)sampleGrid:(LBZXBitMatrix *)image
                 dimensionX:(int)dimensionX
                 dimensionY:(int)dimensionY
                  transform:(LBZXPerspectiveTransform *)transform
                      error:(NSError **)error;
 ...
 */
+ (BOOL)checkAndNudgePoints:(LBZXBitMatrix *)image points:(float *)points pointsLen:(int)pointsLen error:(NSError **)error;
