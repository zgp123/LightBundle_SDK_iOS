 ...
 */
@interface LBZXGenericGF : NSObject

@property (nonatomic, strong, readonly) LBZXGenericGFPoly *zero;
@property (nonatomic, strong, readonly) LBZXGenericGFPoly *one;
 ...
 */
- (LBZXGenericGFPoly *)buildMonomial:(int)degree coefficient:(int)coefficient;
