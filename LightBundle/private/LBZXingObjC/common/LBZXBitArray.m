...
// For testing only
- (id)initWithBits:(LBZXIntArray *)bits size:(int)size {
...
- (void)appendBitArray:(LBZXBitArray *)other {
...
- (void)toBytes:(int)bitOffset array:(LBZXByteArray *)array offset:(int)offset numBytes:(int)numBytes {
...
- (LBZXIntArray *)bitArray {
  LBZXIntArray *array = [[LBZXIntArray alloc] initWithLength:self.bitsLength];
  memcpy(array.array, self.bits, array.length * sizeof(int32_t));
  return array;
}

- (BOOL)isEqual:(id)o {
  if (![o isKindOfClass:[LBZXBitArray class]]) {
    return NO;
  }
  LBZXBitArray *other = (LBZXBitArray *)o;
...
- (id)copyWithZone:(NSZone *)zone {
  LBZXBitArray *copy = [[LBZXBitArray allocWithZone:zone] initWithSize:self.size];
