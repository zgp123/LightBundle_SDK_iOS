...
extern const int LBZX_FINDER_PATTERN_MIN_SKIP;
extern const int LBZX_FINDER_PATTERN_MAX_MODULES;

@protocol LBZXResultPointCallback;
@class LBZXBitMatrix, LBZXDecodeHints, LBZXQRCodeFinderPatternInfo;
 ...
 */
@interface LBZXQRCodeFinderPatternFinder : NSObject
