...
@class LBZXBitMatrix, LBZXQRCodeAlignmentPattern;
 ...
 */
@interface LBZXQRCodeAlignmentPatternFinder : NSObject
 ...
 *
 * @return LBZXAlignmentPattern if found or nil if not found
 */
