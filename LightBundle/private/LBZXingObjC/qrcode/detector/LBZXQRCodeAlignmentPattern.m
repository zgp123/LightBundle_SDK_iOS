...
@interface LBZXQRCodeAlignmentPattern ()

@property (nonatomic, assign, readonly) float estimatedModuleSize;

@end

@implementation LBZXQRCodeAlignmentPattern
...
- (LBZXQRCodeAlignmentPattern *)combineEstimateI:(float)i j:(float)j newModuleSize:(float)newModuleSize {
  ...
  return [[LBZXQRCodeAlignmentPattern alloc] initWithPosX:combinedX posY:combinedY estimatedModuleSize:combinedModuleSize];
}
