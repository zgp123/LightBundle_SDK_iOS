 ...
 */
@interface LBZXQRCodeFinderPattern : LBZXResultPoint
 ...
 * with a new estimate. It returns a new LBZXFinderPattern containing a weighted average
 * based on count.
 */
- (LBZXQRCodeFinderPattern *)combineEstimateI:(float)i j:(float)j newModuleSize:(float)newModuleSize;
