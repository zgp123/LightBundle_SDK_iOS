...
@class LBZXByteArray, LBZXQRCodeErrorCorrectionLevel, LBZXQRCodeVersion;
 ...
 */
@interface LBZXQRCodeDataBlock : NSObject

@property (nonatomic, strong, readonly) LBZXByteArray *codewords;
