...
@class LBZXBitMatrix, LBZXByteArray, LBZXQRCodeFormatInformation, LBZXQRCodeVersion;

@interface LBZXQRCodeBitMatrixParser : NSObject
 ...
 *
 * @return LBZXFormatInformation encapsulating the QR Code's format info
 ...
 *
 * @return LBZXQRCodeVersion encapsulating the QR Code's version or nil
...
/**
 * Reads the bits in the LBZXBitMatrix representing the finder pattern in the
