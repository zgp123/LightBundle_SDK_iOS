...
@class LBZXPDF417BarcodeMatrix, LBZXIntArray;

/**
 * Top-level class for the logic part of the PDF417 implementation.
 */
@interface LBZXPDF417 : NSObject

@property (nonatomic, strong, readonly) LBZXPDF417BarcodeMatrix *barcodeMatrix;
@property (nonatomic, assign) BOOL compact;
@property (nonatomic, assign) LBZXPDF417Compaction compaction;
 ...
 */
- (LBZXIntArray *)determineDimensions:(int)sourceCodeWords errorCorrectionCodeWords:(int)errorCorrectionCodeWords error:(NSError **)error;
