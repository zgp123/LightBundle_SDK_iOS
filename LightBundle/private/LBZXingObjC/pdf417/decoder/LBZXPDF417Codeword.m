...
const int LBZX_PDF417_BARCODE_ROW_UNKNOWN = -1;

@implementation LBZXPDF417Codeword
...
- (id)initWithStartX:(int)startX endX:(int)endX bucket:(int)bucket value:(int)value {
  ...
  if (self) {
    ...
    _bucket = bucket;
    _value = value;
    _rowNumber = LBZX_PDF417_BARCODE_ROW_UNKNOWN;
  }
...
- (BOOL)isValidRowNumber:(int)rowNumber {
  return rowNumber != LBZX_PDF417_BARCODE_ROW_UNKNOWN && self.bucket == (rowNumber % 3) * 3;
}
