...
const int LBZX_PDF417_ADJUST_ROW_NUMBER_SKIP = 2;

@interface LBZXPDF417DetectionResult ()

@property (nonatomic, strong, readonly) LBZXPDF417BarcodeMetadata *barcodeMetadata;
...
@implementation LBZXPDF417DetectionResult

- (id)initWithBarcodeMetadata:(LBZXPDF417BarcodeMetadata *)barcodeMetadata boundingBox:(LBZXPDF417BoundingBox *)boundingBox {
  self = [super init];
  if (self) {
...
- (NSArray *)detectionResultColumns {
  ...
  int unadjustedCodewordCount = LBZX_PDF417_MAX_CODEWORDS_IN_BARCODE;
...
- (void)adjustIndicatorColumnRowNumbers:(LBZXPDF417DetectionResultColumn *)detectionResultColumn {
  if (detectionResultColumn && (id)detectionResultColumn != [NSNull null]) {
    [(LBZXPDF417DetectionResultRowIndicatorColumn *)detectionResultColumn adjustCompleteIndicatorColumnRowNumbers:self.barcodeMetadata];
  }
}
...
- (void)adjustRowNumbersFromBothRI {
  ...
  NSArray *LRIcodewords = [(LBZXPDF417DetectionResultColumn *)self.detectionResultColumnsInternal[0] codewords];
  NSArray *RRIcodewords = [(LBZXPDF417DetectionResultColumn *)self.detectionResultColumnsInternal[self.barcodeColumnCount + 1] codewords];
  for (int codewordsRow = 0; codewordsRow < [LRIcodewords count]; codewordsRow++) {
    if (LRIcodewords[codewordsRow] != [NSNull null] &&
        ...
        [(LBZXPDF417Codeword *)LRIcodewords[codewordsRow] rowNumber] == [(LBZXPDF417Codeword *)RRIcodewords[codewordsRow] rowNumber]) {
      for (int barcodeColumn = 1; barcodeColumn <= self.barcodeColumnCount; barcodeColumn++) {
        LBZXPDF417Codeword *codeword = [(LBZXPDF417DetectionResultColumn *)self.detectionResultColumnsInternal[barcodeColumn] codewords][codewordsRow];
        if ((id)codeword == [NSNull null]) {
          continue;
        }
        codeword.rowNumber = [(LBZXPDF417Codeword *)LRIcodewords[codewordsRow] rowNumber];
        if (![codeword hasValidRowNumber]) {
          [(LBZXPDF417DetectionResultColumn *)self.detectionResultColumnsInternal[barcodeColumn] codewords][codewordsRow] = [NSNull null];
        }
      }
    }
  }
...
- (int)adjustRowNumbersFromRRI {
  ...
  for (int codewordsRow = 0; codewordsRow < [codewords count]; codewordsRow++) {
    ...
    for (int barcodeColumn = self.barcodeColumnCount + 1; barcodeColumn > 0 && invalidRowCounts < LBZX_PDF417_ADJUST_ROW_NUMBER_SKIP; barcodeColumn--) {
      if (self.detectionResultColumnsInternal[barcodeColumn] != [NSNull null]) {
        LBZXPDF417Codeword *codeword = [self.detectionResultColumnsInternal[barcodeColumn] codewords][codewordsRow];
        if ((id)codeword != [NSNull null]) {
...
- (int)adjustRowNumbersFromLRI {
  ...
  for (int codewordsRow = 0; codewordsRow < [codewords count]; codewordsRow++) {
    ...
    int rowIndicatorRowNumber = [codewords[codewordsRow] rowNumber];
    int invalidRowCounts = 0;
    for (int barcodeColumn = 1; barcodeColumn < self.barcodeColumnCount + 1 && invalidRowCounts < LBZX_PDF417_ADJUST_ROW_NUMBER_SKIP; barcodeColumn++) {
      if (self.detectionResultColumnsInternal[barcodeColumn] != [NSNull null]) {
        LBZXPDF417Codeword *codeword = [self.detectionResultColumnsInternal[barcodeColumn] codewords][codewordsRow];
        if ((id)codeword != [NSNull null]) {
          invalidRowCounts = [self adjustRowNumberIfValid:rowIndicatorRowNumber invalidRowCounts:invalidRowCounts codeword:codeword];
...
- (int)adjustRowNumberIfValid:(int)rowIndicatorRowNumber invalidRowCounts:(int)invalidRowCounts codeword:(LBZXPDF417Codeword *)codeword {
  if (!codeword) {
...
- (void)adjustRowNumbers:(int)barcodeColumn codewordsRow:(int)codewordsRow codewords:(NSArray *)codewords {
  LBZXPDF417Codeword *codeword = codewords[codewordsRow];
  ...
  for (LBZXPDF417Codeword *otherCodeword in otherCodewords) {
 ...
 */
- (BOOL)adjustRowNumber:(LBZXPDF417Codeword *)codeword otherCodeword:(LBZXPDF417Codeword *)otherCodeword {
...
- (void)setDetectionResultColumn:(int)barcodeColumn detectionResultColumn:(LBZXPDF417DetectionResultColumn *)detectionResultColumn {
...
- (LBZXPDF417DetectionResultColumn *)detectionResultColumn:(int)barcodeColumn {
  LBZXPDF417DetectionResultColumn *result = self.detectionResultColumnsInternal[barcodeColumn];
  return (id)result == [NSNull null] ? nil : result;
}

- (NSString *)description {
  LBZXPDF417DetectionResultColumn *rowIndicatorColumn = self.detectionResultColumnsInternal[0];
